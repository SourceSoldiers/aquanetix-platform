package com.sourcesoldiers.aquanetix.platform.iam.infrastructure.authorization.sfs.configuration;

import com.sourcesoldiers.aquanetix.platform.iam.infrastructure.authorization.sfs.pipeline.BearerAuthorizationRequestFilter;
import com.sourcesoldiers.aquanetix.platform.iam.infrastructure.hashing.bcrypt.BCryptHashingService;
        ...
        http.csrf(csrfConfigurer -> csrfConfigurer.disable())
                ...
                .authorizeHttpRequests(authorizeRequests -> authorizeRequests
                        .requestMatchers(
                                ...
                                "/swagger-resources/**",
                                "/webjars/**").permitAll()
                        .requestMatchers(HttpMethod.GET, "/api/v1/courses/**").hasAnyRole("USER", "INSTRUCTOR", "ADMIN")
