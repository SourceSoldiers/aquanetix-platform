package com.sourcesoldiers.aquanetix.platform.shared.infrastructure.persistence.jpa.strategy;
...
public class SnakeCasePhysicalNamingStrategy implements PhysicalNamingStrategy {
    ...
    private Identifier toPlural(final Identifier identifier) {
        String plural = identifier.getText() + "s"; // Fast solution without pluralize.
